...
<aside class="w-64 bg-white shadow-sm border-r border-gray-200 h-full">
	<div class="p-6">
		...
		<div class="mt-8 pt-6 border-t border-gray-200">
			...
			<div class="space-y-2">
				<button class="w-full flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-900 transition-colors">
